...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        output_path = "/Users/xuyuan/workspace/py/pythonProject1/sim3/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
# gt16 simulation 3
parameters = ["N0", "NInfinity", "b", "tree.height", "tree.treeLength"]
# stats_format = "../stats/gt16_coal_n16_L200_%d_stats.log"
stats_format = "/Users/xuyuan/workspace/py/pythonProject1/sim3/stats/gompCoal-%d_stats.log"
# true_format = "../data/gt16CoalErrModel_%d_true.log"
true_format = "/Users/xuyuan/workspace/py/pythonProject1/sim3/data/gompCoal-%d.log"
