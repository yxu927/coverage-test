...
def append_stats_all():
    for i in range(100):
        tree_file = "/Users/xuyuan/workspace/py/pythonProject1/sim3/data/gompCoal-%d_tree.trees" % i
        true_file = "/Users/xuyuan/workspace/py/pythonProject1/sim3/data/gompCoal-%d.log" % i
