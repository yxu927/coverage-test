...
def plot_figs(stats_path, true_path, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        output_path = "/Users/xuyuan/workspace/py/pythonProject1/sim4/figures/" + parameter.lower().replace(".", "_") + ".pdf"
...
stats_format = "/Users/xuyuan/workspace/py/pythonProject1/sim4/stats/gompCoal-%d_stats.log"
# true_format = "../data/gt16CoalErrModel_%d_true.log"
true_format = "/Users/xuyuan/workspace/py/pythonProject1/sim4/data/gompCoal-%d.log"
